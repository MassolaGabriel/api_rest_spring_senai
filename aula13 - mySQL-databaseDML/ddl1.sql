...
CREATE TABLE componentes_fornecedores (
  ...
  CONSTRAINT fk_cf_componente FOREIGN KEY (id_componente) REFERENCES componentes(id_componente) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT fk_cf_fornecedor FOREIGN KEY (id_fornecedor) REFERENCES fornecedores(id_fornecedor) ON DELETE CASCADE ON UPDATE CASCADE
);
...
CREATE TABLE ordens_producao (
  ...
  CONSTRAINT fk_op_componente FOREIGN KEY (id_componente) REFERENCES componentes(id_componente) ON DELETE CASCADE ON UPDATE CASCADE
);
